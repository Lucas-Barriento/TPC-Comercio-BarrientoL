...
-- PROCEDIMIENTOS
CREATE PROCEDURE SP_INSERTPROVEEDOR_NUEVOPRODUCTO(@IDPROVEEDOR BIGINT)
	AS 
	BEGIN
...
CREATE PROCEDURE SP_ELIMINAR_PROVEEDORESXIDPRODUCTO(
@IDPRODUCTO BIGINT
)
AS
BEGIN
...
--INSERT
	...
	insert into PRODUCTO values('Samsung a12',1,1,1,1,10,1),('Bicicleta R29 21V',1,1,1,1,5,1)
	insert into CLIENTE values ('37763043','Lucas','Barriento',1)
	insert into PROVEEDORES_PRODUCTOS values (3,1)
